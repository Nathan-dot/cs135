...
#reader(lib "htdp-intermediate-lambda-reader.ss" "lang")((modname a09q02-lambda) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;; ***************************************************
...
(define (ruthless symbols-nlst)
  (filter-nlst (lambda (sym)
                 (cond [(symbol=? sym 'ruth) false]
                       [else true])) symbols-nlst))
